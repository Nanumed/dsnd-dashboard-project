...
@pytest.fixture
def project_root():
    return Path(__file__).resolve().parent.parent  # Points to the root of the project directory
...
# the creates the "fixture" for the database's filepath
...
def test_employee_table_exists(table_names):
    ...
    assert 'employee' in table_names, "Table 'employee' does not exist."
...
def test_team_table_exists(table_names):
    ...
    assert 'team' in table_names, "Table 'team' does not exist."
...
def test_employee_events_table_exists(table_names):
    ...
    assert 'employee_events' in table_names, "Table 'employee_events' does not exist."
